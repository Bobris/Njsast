(e => {
    ...
    zt(String.prototype, "endsWith", function(e, t) {
        var n, r;
        n = this.toString();
        (!Lt(t) || !isFinite(t) || Math.floor(t) !== t || t > n.length) && (t = n.length);
        t -= e.length;
        r = n.indexOf(e, t);
        return r !== -1 && r === t;
    });
    ...
    function pn(t, n, r, i) {
        ...
        p && S === a && (p = !1);
        f && (h = !0);
        (a.attrs || p) && (a.attrs = ln(a, m, a.attrs, {}, p));
        a.style && an(m, a.style, e);
        C = a.className;
        C && dn(m, C);
        h = d;
        p = o;
    ...
    function bn(t) {
        ...
        if (a) {
            ...
            jt = d;
            Y !== X && Y(t, W.Destroy);
            a.destroy && a.destroy(d, t, t.element);
            o = d.disposables;
            if (l(o)) {
                for (c = o.length; c-- > 0; ) {
                    s = o[c];
    ...
    function Sn(t, n, r, i, a, d) {
        ...
        if (o != null && u != null) {
            ...
            if (o.id !== n.component.id) {
                ...
                u.data = t.data || {};
                n.component = o;
                Y !== X && Y(t, d ? W.LocalUpdate : W.Update);
                if (o.render) {
                    n.orig = t;
                    t = f({}, t);
                    n.cfg = e;
        ...
        if (c || o != e && u == e || o == e && u != e && u.me.component !== s) {} else if (g === "/") {
            ...
            if (g === e) {
                ...
                w && (h = !0);
                wn(t, n, o);
                (n.attrs || t.attrs || p) && (n.attrs = ln(n, C, t.attrs, n.attrs || {}, p));
    ...
    function Kn(t, n, r) {
        ...
        for (a = 0; a < i; a++) {
            ...
            if (o != null && o[j] >= M) {
                ...
                s = p;
                p && S === d && (p = !1);
                if (d.tag === "svg") h = !0; else h && d.tag === "foreignObject" && (h = !1);
                u = d.element;
                if (u != e) {
    ...
    function ar(t, n, r) {
        ...
        } else Yt(r) && r.target == e && (r.target = t);
        i = lr(n, r);
        if (i != e) return i;
        a = Tt;
        while (t) {
                    ...
                    for (s = 0, u = c.length; s < u; s++) {
                        ...
                        if (f instanceof At) {
                            ...
                            if (h !== e) {
                                ...
                                p == Pt.NotHandledPreventDefault && (i = l);
                            }
                        }
                    }
                }
                ...
                for (s = 0, u = c.length; s < u; s++) {
                    ...
                    if (f instanceof At) {
                        ...
                        if (h !== e) {
                            ...
                            p == Pt.NotHandledPreventDefault && (m = a);
                        }
                    }
                }
            }
    ...
    function fr(e) {
        ...
        Yt(t.style) && (t.style = f({}, t.style));
        n = t.children;
        if (n) {
            if (l(n)) {
                t.children = ur(n);
            } else Yt(n) && (t.children = fr(n));
        }
        return t;
    }
    function hr(e, t) {
    ...
    function Kr(e, t, n) {
        ...
        if (Ie === e.id) {
            Vr(e);
            (!Mr(Re, e.x, ve) || !Mr(Ae, e.y, ve)) && (Fe = !0);
        } else Hr() && Vr(e);
        return !1;
    }
    Be = 0;
    ...
    function ti(t) {
        ...
        while (!0) {
            ...
            while (a >= i) {
                ...
                if (d) {
                    o = d.component;
                    o && o.onFocusOut && o.onFocusOut(d.ctx);
                }
                a--;
            }
            a = i;
            while (a + 1 < r.length) {
                ...
                if (d) {
                    o = d.component;
                    o && o.onFocusIn && o.onFocusIn(d.ctx);
                }
                a++;
            }
            if (a < r.length) {
    ...
    et = {
        render: function(e, t) {
            ...
            d = di();
            if (d) {
                a.cursor !== d && a.setProperty("cursor", d, "important");
            } else {
    ...
    tt.destroy = function() {
        var e, t;
        this.ended = !0;
        this.started && cr("onDragEnd", this);
    ...
    function Di() {
        ...
        if (pt) {
            ...
            for (_ = 0; _ < st.length; _++) {
                ...
                if (c !== l.lastColor) {
                    l.lastColor = c;
                    l.width == e && (l.width = C.width);
                    l.height == e && (l.height = C.height);
            ...
            for (z in dt) {
                ...
                P = N.pseudo;
                R = N.style;
                Xt(R) && R.length === 0 && (A = n(R(), 2), R = A[0], P = A[1]);
                if (Kt(R) && P == e) {
                    N.realName = R;
                    continue;
                }
